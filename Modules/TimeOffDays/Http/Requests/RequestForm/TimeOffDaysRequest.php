...
class TimeOffDaysRequest extends BaseFormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            "time_off_days_shift"   => "required|array",
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'time_off_note.required'        => __('Lý do không được trống.'),
            'time_off_days_shift.required'  => __('Ca làm việc không được trống.'),
            'time_off_days_shift.array'     => __('Ca làm việc kiểu dữ liệu là mảng.'),
        ];
    }
