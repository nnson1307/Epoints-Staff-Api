...
class NString
{
     ...
     * @return string
     */
    public static function removeDiacriticalMarks_loi($str)
    {
    ...
    /**
     * Tạo chuỗi 9 ký tự ngẫu nhiên
     *
     * @return string
     */
    public static function createUniqueString()
    {
        $rand = substr(uniqid(sha1(time())),-4);

        return strtoupper(date('y') . dechex(date('md')) . $rand);
    }



    private static $defaultDiacriticsRemovalMap = array(
        array(
            'base'=>"A",
    ...
    public static function removeDiacriticalMarks($str)
    {
        $flags = "um";
        for ($i = 0; $i < sizeof(self::$defaultDiacriticsRemovalMap); $i++) {
            $str = preg_replace(self::$defaultDiacriticsRemovalMap[$i]['letters'].$flags, self::$defaultDiacriticsRemovalMap[$i]['base'], $str);
        }
